...
class DataHealthMetrics(BaseModel):
    ...
    completeness: float = Field(..., ge=0.0, le=100.0, description="Data completeness percentage")
    freshness_seconds: int = Field(..., description="Age of most recent data in seconds")
    ...
    consistency_score: float = Field(..., ge=0.0, le=100.0, description="Data consistency score")
